            ...
            while ($data = mysqli_fetch_assoc($row)) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a onclick="if(confirm('Apakah anda yakin ingin menghapus data ini ??')){ location.href='supplier-delete.php?nip=<?php echo $data['nip']; ?>' }" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a> 
